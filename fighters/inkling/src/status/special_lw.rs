...
pub unsafe extern "C" fn special_lw_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    VarModule::off_flag(fighter.battle_object, vars::inkling::instance::SPECIAL_LW_CANCELLED);
...
pub unsafe extern "C" fn special_lw_exec(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if ControlModule::check_button_on(fighter.module_accessor,*CONTROL_PAD_BUTTON_GUARD) {
        VarModule::on_flag(fighter.battle_object, vars::inkling::instance::SPECIAL_LW_CANCELLED);
